...
\textcolor{purple}{The colors are matched between Figure 5 and 6. We have increased the size of the cluster labels in Figure 6 to make them more readable, and have added a color legend. Variable nams in Figure 6 have been matched to those in Figure 5, and are now always added in parentheses when mentioned in the text.}
