...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{paper_files/figure-pdf/fig-ci-1.pdf}
...
\includegraphics[width=2.60417in,height=\textheight,keepaspectratio]{images/example1.png}
...
\includegraphics[width=2.60417in,height=\textheight,keepaspectratio]{images/example2.png}
...
difficult to compare the new sample precisely against the normal ranges,
...
Let \(x\) be a \pD{} vector. A \pD{} ellipsoid corresponding to a given
variance-covariance (\(\Sigma\)) is defined by
...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{images/anomaly1.png}
...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{images/anomaly2.png}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1474}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1474}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.2000}}
...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{images/liver1.png}
...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{images/liver2.png}
...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{images/weather1.png}
...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{images/weather2.png}
...
\includegraphics[width=6.25in,height=\textheight,keepaspectratio]{images/weather3.png}
