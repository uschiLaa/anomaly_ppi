...
\subcaption{\label{fig-weather1}All outlying points.}
...
\caption{\label{fig-weather}Projection identified by the anomaly index.
(a) shows the preferred projection when averaging all outlying points.
(b) shows the preferred projection when optimizing only for cluster 4,
which could not be resolved in the view in (a).}
