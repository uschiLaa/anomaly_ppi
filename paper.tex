...
For example, \citet{fit-compare} compares a new sample of patient scores
against the normal range represented by an ellipse.
...
\includegraphics[width=3.125in,height=\textheight]{images/example1.png}

}

\subcaption{\label{fig-compare1}Sample of patients relative to
confidence ellipse.}
...
\includegraphics[width=3.125in,height=\textheight]{images/example2.png}

}

\subcaption{\label{fig-compare}Sample of patients relative to relative
to simulated sample of normal patients.}

\end{minipage}%

\caption{\label{fig-compare}Illustration of current procedure: (a)
compare new sample with points of the surface of a \(p-D\) ellipse, (b)
compare new sample with a simulated sample of normal patients. Although
both approaches are useful, the rough edges of the projected ellipse
points makes it difficult to precisely assess the positions of the new
sample against the normal bounds.}
